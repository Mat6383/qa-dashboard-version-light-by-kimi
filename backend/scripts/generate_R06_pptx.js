...
s1.addText('Release R06 — Test Closure Report', {
  x: 0.5,
  y: 2.2,
  w: 9,
  h: 0.5,
...
s1.addText('Décision conditionnelle — Critères partiellement atteints', {
  x: 1.0,
  y: 3.9,
  w: 8,
  h: 0.35,
...
const infoRows = [
  [
    ...
    {
      text: '09 fév. → 27 mars 2026 (46j)    ',
      options: { color: C.ice, fontSize: 9, fontFace: 'Calibri', bold: true },
    },
    { text: 'Périmètre: ', options: { color: C.gray, fontSize: 9, fontFace: 'Calibri' } },
    {
      text: '12 runs + 3 sessions exploratoires',
      options: { color: C.ice, fontSize: 9, fontFace: 'Calibri', bold: true },
    },
  ],
];
...
s2.addText('Executive Summary — ISTQB §5.4.2', {
  x: 0.5,
  y: 0.75,
  w: 6,
  h: 0.3,
...
kpis.forEach((k, i) => {
  ...
  s2.addText(k.target, {
    ...
    fontSize: 7.5,
    fontFace: 'Calibri',
    color: k.ok ? C.green : C.red,
    align: 'center',
    valign: 'middle',
    fill: { color: k.ok ? 'DCFCE7' : 'FEE2E2' },
  });
});

// Volumes
s2.addText('Volumes de la campagne', {
  x: 0.5,
  y: 3.3,
  w: 4,
  h: 0.35,
...
s2.addText('Répartition des statuts', {
  x: 5.3,
  y: 3.3,
  w: 4.2,
  h: 0.35,
...
s3.addText('Detailed Test Results — ISTQB §5.4', {
  x: 0.5,
  y: 0.75,
  w: 6,
  h: 0.3,
...
const runRows = [
  ...
  [
    { text: 'Run 1', options: { fontSize: 8, bold: true } },
    '92',
    { text: '77', options: { color: C.green, fontSize: 8 } },
    { text: '14', options: { color: C.red, fontSize: 8 } },
    '1',
    '0',
    '100%',
    { text: '83,7%', options: { color: C.red, fontSize: 8, bold: true } },
  ],
  [
    { text: 'Run 2', options: { fontSize: 8, bold: true } },
    '8',
    { text: '7', options: { color: C.green, fontSize: 8 } },
    '0',
    '1',
    '0',
    '100%',
    { text: '87,5%', options: { color: C.orange, fontSize: 8 } },
  ],
  [
    { text: 'Run 3', options: { fontSize: 8, bold: true } },
    '14',
    { text: '11', options: { color: C.green, fontSize: 8 } },
    { text: '3', options: { color: C.red, fontSize: 8 } },
    '0',
    '0',
    '100%',
    { text: '78,6%', options: { color: C.red, fontSize: 8 } },
  ],
  [
    { text: 'Run 4', options: { fontSize: 8, bold: true } },
    '11',
    { text: '8', options: { color: C.green, fontSize: 8 } },
    { text: '3', options: { color: C.red, fontSize: 8 } },
    '0',
    '0',
    '100%',
    { text: '72,7%', options: { color: C.red, fontSize: 8 } },
  ],
  [
    { text: 'Run 5', options: { fontSize: 8, bold: true } },
    '5',
    { text: '3', options: { color: C.green, fontSize: 8 } },
    '0',
    '0',
    { text: '2', options: { color: C.orange, fontSize: 8 } },
    { text: '60%', options: { color: C.red, fontSize: 8 } },
    { text: '100%', options: { color: C.green, fontSize: 8 } },
  ],
  [
    { text: 'Run 6', options: { fontSize: 8, bold: true } },
    '2',
    { text: '2', options: { color: C.green, fontSize: 8 } },
    '0',
    '0',
    '0',
    '100%',
  ...
  [
    { text: 'Run 7', options: { fontSize: 8, bold: true } },
    '2',
    { text: '2', options: { color: C.green, fontSize: 8 } },
    '0',
    '0',
  ...
  [
    { text: 'Run 8', options: { fontSize: 8, bold: true } },
    '6',
    { text: '5', options: { color: C.green, fontSize: 8 } },
    { text: '1', options: { color: C.red, fontSize: 8 } },
    '0',
    '0',
    '100%',
    { text: '83,3%', options: { color: C.red, fontSize: 8 } },
  ],
  [
    { text: 'Run 9', options: { fontSize: 8, bold: true } },
    '4',
    { text: '4', options: { color: C.green, fontSize: 8 } },
    '0',
    '0',
    '0',
    '100%',
...
s3.addTable(runRows, {
  ...
  color: C.text,
  border: { pt: 0.5, color: 'E2E8F0' },
  colW: [1.3, 0.8, 0.9, 0.9, 0.7, 0.7, 1.0, 1.0],
  autoPage: false,
  align: 'center',
  valign: 'middle',
});
...
// TNR section
s3.addText('Tests de non-régression (TNR — Regression Testing)', {
  x: 0.5,
  y: 3.95,
  w: 6,
  h: 0.35,
...
const tnrRows = [
  ...
  [
    'TNR — Flux de production',
    '18',
    { text: '15', options: { color: C.green, fontSize: 8 } },
    { text: '3', options: { color: C.red, fontSize: 8 } },
    { text: '83,3%', options: { color: C.red, fontSize: 8, bold: true } },
    { text: 'ATTENTION', options: { color: C.orange, fontSize: 8, bold: true } },
  ],
  [
    'TNR — Tableaux de bord',
    '1',
    '0',
    { text: '1', options: { color: C.red, fontSize: 8 } },
    { text: '0%', options: { color: C.red, fontSize: 8, bold: true } },
    { text: 'CRITIQUE', options: { color: C.red, fontSize: 8, bold: true } },
  ],
  [
    'TNR — Analyseur',
    '1',
    { text: '1', options: { color: C.green, fontSize: 8 } },
    '0',
    { text: '100%', options: { color: C.green, fontSize: 8, bold: true } },
    { text: 'OK', options: { color: C.green, fontSize: 8, bold: true } },
  ],
];
s3.addTable(tnrRows, {
  x: 0.5,
...
s4.addText('Sessions exploratoires & Analyse', {
  x: 0.5,
  y: 0.3,
  w: 7,
  h: 0.5,
...
s4.addText('Exploratory Testing (ISTQB §4.4.2) & Defect Analysis', {
  x: 0.5,
  y: 0.75,
  w: 7,
  h: 0.3,
...
const sessRows = [
  ...
  [
    'TEST Exploratoire Sophie',
    { text: '4 anomalies', options: { color: C.red, fontSize: 9 } },
    { text: 'ÉCHEC', options: { color: C.red, fontSize: 9, bold: true } },
    '13/03/2026',
  ],
  [
    'TEST Exploratoire GWELL GAB',
    { text: '1 réussi / 1 échoué', options: { color: C.orange, fontSize: 9 } },
    { text: 'MIXTE', options: { color: C.orange, fontSize: 9, bold: true } },
    '17/03/2026',
  ],
  [
    'TEST Exploratoire Pauline',
    { text: 'En cours', options: { color: C.gray, fontSize: 9 } },
    { text: 'EN COURS', options: { color: C.gray, fontSize: 9, bold: true } },
    '27/03/2026',
  ],
];
s4.addTable(sessRows, {
  x: 0.5,
  y: 1.2,
  w: 9,
  fontSize: 9,
...
s4.addText('Distribution des anomalies par source', {
  x: 0.5,
  y: 2.7,
  w: 5,
  h: 0.35,
...
s4.addText(
  [
    ...
    {
      text: '(14/25), confirmant le principe ISTQB de regroupement des défauts (Defect Clustering §1.3).',
      options: { fontSize: 9, breakLine: true },
    },
    { text: '', options: { fontSize: 6, breakLine: true } },
    { text: 'Tendance positive :', options: { bold: true, fontSize: 9, breakLine: true } },
    {
      text: 'Les runs tardifs (6, 7, 10) affichent 100% de succès. Le produit se stabilise.',
      options: { fontSize: 9, breakLine: true },
    },
    { text: '', options: { fontSize: 6, breakLine: true } },
...
s5.addText('Exit Criteria Assessment — ISTQB §5.2.3', {
  x: 0.5,
  y: 0.75,
  w: 6,
  h: 0.3,
...
s5.addText(
  'Bilan ISTQB : 2 critères sur 5 atteints. Les critères non satisfaits doivent être acceptés formellement (§5.2.3).',
  {
    x: 0.7,
    y: 5.0,
    w: 8.6,
...
s6.addText('ISTQB §5.3 Defect Report / ITIL Incident Management', {
  x: 0.5,
  y: 0.75,
  w: 7,
  h: 0.3,
...
incidents.forEach((inc, i) => {
  ...
  s6.addText(inc.severity, {
    ...
    align: 'center',
    valign: 'middle',
    fill: { color: inc.sevColor === C.red ? 'FEE2E2' : 'FEF3C7' },
  });
...
s7t.addText('Traçabilité des tickets GitLab', {
  x: 0.5,
  y: 0.3,
  w: 7,
  h: 0.5,
...
s7t.addText('Defect Traceability — ISTQB §5.3', {
  x: 0.5,
  y: 0.75,
  w: 6,
  h: 0.3,
...
const ticketRows = [
  ...
  [
    'run 1',
    '[STOCK] Modifier la série après entrée interne',
    { text: 'FAILED', options: ticketFail },
    { text: '#7802', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 1',
    '[ODF] Faire redescendre la date de livraison',
    { text: 'FAILED', options: ticketFail },
    { text: '#7792', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 1',
    '[EDI] Import stock : optimisation des traitements',
    { text: 'FAILED', options: ticketFail },
    { text: '#7787', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 1',
    '[FACTURE][CONFIE] Ajout des frais de port',
    { text: 'FAILED', options: ticketFail },
    { text: '#7786', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 1',
    '[GENERAL] Numérique au format US 1,000.00',
    { text: 'FAILED', options: ticketFail },
    { text: '#7781', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 1',
    '[ARTICLE] Le filtre: Article créé depuis le…',
    { text: 'FAILED', options: ticketFail },
    { text: '#7784', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 3',
    '[ERC] Nouveau document CJI',
    { text: 'FAILED', options: ticketFail },
    { text: '#7806', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 3',
    '[CRON] Deport cron Boucheron vers Pilote',
    { text: 'FAILED', options: ticketFail },
    { text: '#7794', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 4',
    '[EDI][STOCK] Ajout valeurs douanières import appro',
    { text: 'FAILED', options: ticketFail },
    { text: '#7831', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 4',
    '[GENERAL] Numérique format US — Retours 2',
    { text: 'FAILED', options: ticketFail },
    { text: '#7807', options: { bold: true, fontSize: 7 } },
  ],
  [
    'TNR',
    '09 — Avoir / Livre de police',
    { text: 'FAILED', options: ticketFail },
    { text: '#7821', options: { bold: true, fontSize: 7 } },
  ],
  [
    'TNR',
    '07 — Transformations',
    { text: 'FAILED', options: ticketFail },
    { text: '#7811', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 8',
    '[VALORISATION METAL] COFITER / COFIPAC KO',
    { text: 'FAILED', options: ticketFail },
    { text: '#7834', options: { bold: true, fontSize: 7 } },
  ],
  [
    'run 1',
    '[CONFIE] Ajout frais de port état standard',
    { text: 'PASSED', options: ticketPass },
    { text: '#7774', options: { bold: true, fontSize: 7, color: C.green } },
  ],
  [
    'run 2',
    '[ARIBA] Articles avec prix à 0',
    { text: 'PASSED', options: ticketPass },
    { text: '#7796', options: { bold: true, fontSize: 7, color: C.green } },
  ],
  [
    'run 5',
    '[CDE ACHAT][CP] Solde ligne — mvt prévi.',
    { text: 'PASSED', options: ticketPass },
    { text: '#7824', options: { bold: true, fontSize: 7, color: C.green } },
  ],
];
s7t.addTable(ticketRows, {
  x: 0.2,
  y: 1.1,
  w: 9.6,
  fontSize: 7,
...
s7t.addText('13 tickets de correction créés pour les tests FAILED — 3 tickets de suivi pour les tests PASSED', {
  x: 0.7,
  y: 4.65,
  w: 8.6,
  h: 0.45,
...
s8r.addText('Residual Risks — ISTQB §5.4.2', {
  x: 0.5,
  y: 0.75,
  w: 6,
  h: 0.3,
...
const riskRows = [
  ...
  [
    'R1',
    '14 échecs non résolus (Run 1)',
    { text: 'Moy.', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'Élevé', options: { color: C.red, bold: true, fontSize: 8 } },
    { text: 'CRITIQUE', options: { color: C.red, bold: true, fontSize: 8 } },
    'Re-test ciblé avant MEP',
  ],
  [
    'R2',
    'TNR Tableaux de bord en échec total',
    { text: 'Élevée', options: { color: C.red, bold: true, fontSize: 8 } },
    { text: 'Moyen', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'CRITIQUE', options: { color: C.red, bold: true, fontSize: 8 } },
    'Investigation & correction',
  ],
  [
    'R3',
    '2 tests WIP dans le Run 5',
    { text: 'Moy.', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'Moyen', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'MODÉRÉ', options: { color: C.orange, bold: true, fontSize: 8 } },
    'Finaliser avant MEP',
  ],
  [
    'R4',
    'Session exploratoire Pauline en cours',
    { text: 'Faible', options: { color: C.accent, bold: true, fontSize: 8 } },
    { text: 'Faible', options: { color: C.accent, bold: true, fontSize: 8 } },
    { text: 'FAIBLE', options: { color: C.accent, bold: true, fontSize: 8 } },
  ...
  [
    'R5',
    'Instabilité cron Boucheron',
    { text: 'Moy.', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'Élevé', options: { color: C.red, bold: true, fontSize: 8 } },
    { text: 'CRITIQUE', options: { color: C.red, bold: true, fontSize: 8 } },
    'Monitoring renforcé post-MEP',
  ],
  [
    'R6',
    'Cluster anomalies (session Sophie)',
    { text: 'Moy.', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'Moyen', options: { color: C.orange, bold: true, fontSize: 8 } },
    { text: 'MODÉRÉ', options: { color: C.orange, bold: true, fontSize: 8 } },
...
s8r.addText('3 risques critiques identifiés. Acceptation formelle requise par les parties prenantes avant MEP.', {
  x: 0.7,
  y: 4.0,
  w: 8.6,
  h: 0.5,
...
s9r.addText('Lessons Learned — LEAN Kaizen / ITIL CSI', {
  x: 0.5,
  y: 0.75,
  w: 6,
  h: 0.3,
...
const actions = [
  {
    title: 'Muda — Gaspillage',
    icon: '1',
    desc: "Revue de testabilité avant chaque campagne. Formaliser les critères d'acceptation des cas de test.",
    priority: 'Haute',
    pColor: C.red,
  },
  {
    title: 'Mura — Irrégularité',
    icon: '2',
    desc: 'Processus Change Management (CAB) pour les modifications de processus automatisés.',
    priority: 'Haute',
    pColor: C.red,
  },
  {
    title: 'Jidoka — Qualité intégrée',
    icon: '3',
    desc: 'Renforcer les tests shift-left : revues de code et tests unitaires plus tôt dans le cycle.',
    priority: 'Moyenne',
    pColor: C.orange,
  },
  {
    title: 'Heijunka — Lissage',
    icon: '4',
    desc: 'Répartir la charge de test : max 30 tests par run pour un suivi plus granulaire.',
    priority: 'Moyenne',
    pColor: C.orange,
  },
];
...
actions.forEach((a, i) => {
  ...
  s9r.addText(a.priority, {
    ...
    align: 'center',
    valign: 'middle',
    fill: { color: a.pColor === C.red ? 'FEE2E2' : 'FEF3C7' },
  });
...
s9r.addText(
  [
    ...
    {
      text: 'Tendance positive : runs tardifs à 100% de succès',
      options: { bullet: true, fontSize: 9, breakLine: true },
    },
...
s10.addText('Critères de sortie partiellement atteints — Acceptation formelle requise', {
  x: 2,
  y: 2.15,
  w: 6,
  h: 0.45,
...
// Conditions
s10.addText('Conditions de mise en production :', {
  x: 1.0,
  y: 3.0,
  w: 8,
  h: 0.35,
...
s10.addText(
  [
    {
      text: 'Correction des 3 risques critiques (R1, R2, R5)',
      options: { bullet: true, fontSize: 11, color: C.ice, breakLine: true },
    },
    {
      text: 'Re-test ciblé des 14 échecs du Run 1',
      options: { bullet: true, fontSize: 11, color: C.ice, breakLine: true },
    },
    {
      text: 'Investigation TNR Tableaux de bord (0% pass rate)',
      options: { bullet: true, fontSize: 11, color: C.ice, breakLine: true },
    },
    {
      text: 'Monitoring renforcé post-MEP sur le cron Boucheron',
      options: { bullet: true, fontSize: 11, color: C.ice, breakLine: true },
    },
...
s10.addText('Réf. RC-R06-2026-03-27 | ISTQB CTFL v4.0 | LEAN Six Sigma | ITIL v4 CSI', {
  x: 0.5,
  y: 4.85,
  w: 9,
  h: 0.3,
...
s10.addText('QA Dashboard — Neo-Logix — 27 mars 2026', {
  x: 0.5,
  y: 5.15,
  w: 9,
  h: 0.3,
...
// WRITE FILE
// ================================================================
const outPath = __dirname + '/../../reports/R06_Cloture_Tests.pptx';
pres
